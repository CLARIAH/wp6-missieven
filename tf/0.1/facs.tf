...
@description=url part of the corresponding online facsimile page; the url itself can be constructed using a hard coded template. See also the tpl feature
